...
import { FaTwitter, FaInstagram, FaLinkedinIn, FaGoogle, FaWhatsapp } from 'react-icons/fa';
    ...
    return (
        <div className="flex flex-wrap justify-center md:justify-start gap-2">
            {words.map((word, i) => {
                ...
                const isFirst = i === 0;
                const isSixth = word.toUpperCase() === "INDIAN";
...
export default function Main() {
    const headingText = "PREMIUM CLOUD BUISNESS EMAIL HOSTING INDIAN COMPANY";
    ...
    return (
        ...
        >
            {/* Left section */}
            <div className="max-w-xl md:text-left space-y-2 mt-15 flex flex-col items-center justify-center ">
      ...
      ${bgcolor === 'black' ? 'border-white text-white' : 'border-black text-black'}`}
        ...
        ${bgcolor === 'black' ? 'bg-white' : 'bg-black'}`}
                ...
                <p className="text-gray-600 text-md font-bold md:text-base text-center" style={{ color: textcolors }}>
                    save time of your team and Grow your Buisness our World Class Fadster Cloud Email Service
                </p>
            ...
            {/* Right section */}
            <motion.div
                className="w-full lg:w-1/2 flex justify-center relative mb-8 lg:mb-0 mt-10"
                initial={{ opacity: 0, y: -40 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1 }}
            >
                <div className="relative w-60 sm:w-70 md:w-82 lg:w-120">
                    <img
                        src={banner}
                        alt="Happy User"
